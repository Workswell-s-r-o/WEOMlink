...
private:
    ...
    TimePoint m_lastChangeTimePoint;
    static constexpr std::chrono::milliseconds DEBOUNCE_DELAY_TIME{200};
};
...
void ComboBoxMenuItem<size>::initializeGuiImpl()
{
    ...
    {
        ((ComboBoxMenuItem*)(lv_event_get_user_data(e)))->actionPrevious();
    };
    ...
    {
        ((ComboBoxMenuItem*)(lv_event_get_user_data(e)))->actionNext();
    };
